    ...
    <Reveal className="flex flex-col w-full gap-space-2xl">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-space-xl items-stretch">
        ...
        <CardSpotlight className="xl:col-span-4">
          <div className="h-full bg-surface-container-lowest rounded-2xl p-space-xl shadow-sm border border-surface-container flex flex-col items-center justify-between text-center gap-space-md">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-space-xl items-start">
        <div className="lg:col-span-7 bg-surface-container-lowest rounded-2xl p-space-xl shadow-sm border border-surface-container">
        ...
        <div className="lg:col-span-5 bg-surface-container-lowest rounded-2xl p-space-xl shadow-sm border border-surface-container">
