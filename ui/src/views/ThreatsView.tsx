      ...
      <Reveal className="flex flex-col w-full gap-space-2xl">
        ...
        <CardSpotlight color={level === 'alert' ? 'rgba(220, 38, 38, 0.10)' : level === 'warn' ? 'rgba(217, 119, 6, 0.10)' : 'rgba(5, 150, 105, 0.10)'}>
          <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-space-2xl flex flex-col gap-space-xl">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-space-sm pt-space-md border-t border-outline-variant">
        ...
        <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-space-xl flex flex-col gap-space-lg">
        ...
        <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-space-xl flex flex-col gap-space-lg">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left">
              <thead>
                <tr className="text-on-surface-variant font-body text-xs border-b border-outline-variant">
                      ...
                      {row.photo ? (
                        <span className="inline-flex items-center gap-2">
                          <a href={row.photo} target="_blank" rel="noreferrer" title={`Webcam frame when the alert fired · face: ${row.face ?? 'unchecked'}`}>
                            <img src={row.photo} alt="Webcam frame at the alert" className="h-10 w-14 object-cover rounded-md border border-outline-variant" />
                          </a>
