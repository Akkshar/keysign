import React, { CSSProperties, useEffect, useId, useLayoutEffect, useMemo, useRef, useState } from 'react';
  ...
  return (
    ...
    >
      ...
      >
        ...
        <text
          ref={strokeTextRef}
          className="select-none font-display font-black"
          x="0"
          y="0"
          fill="none"
          stroke={strokeColor}
